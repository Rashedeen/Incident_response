# TrickBot Malware Analysis - CyberOps Final Skills Assessment

## Scenario
As a junior security analyst at a cybersecurity operations center (SOC), I was tasked with investigating a potential malware infection within a simulated enterprise network. An alert indicated suspicious activity tied to the TrickBot trojan — a well-known multi-stage malware associated with credential theft, ransomware, and command-and-control (C2) operations.
